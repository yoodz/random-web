    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="专家抽取系统">Smartisan</router-link>
              <span @click="toRandom" class="title">专家抽取系统</span> 
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              <router-link to="/lottery">抽取列表</router-link>
              <router-link to="/configure">人员列表</router-link>
            </div>
          </div>
        </div>
      </header>
