...
const random = resolve => require(['/page/Random/random'], resolve)
const configure = resolve => require(['/page/Configure/configure'], resolve)
const lottery = resolve => require(['/page/Lottery/lottery'], resolve)
const createLottery = resolve => require(['/page/Lottery/create'], resolve)
Vue.use(Router)
export default new Router({
  ...
  routes: [
    ...
    {path: '/createLottery', name: 'createLottery', component: createLottery},
    {path: '*', redirect: '/random'}
  ]
})
